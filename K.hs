...
-- implementation, these give rise to graded monads (in real life). The result
-- is thus a faithful implementation of the framework for presupposition of
-- chapter 3 of Grove 2019.
